...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/mai/admin/pck/mai.pkb-arc   2.0.1.0   Jun 11 2008 16:13:46   smarshall  $
--       Module Name      : $Workfile:   mai.pkb  $
--       Date into SCCS   : $Date:   Jun 11 2008 16:13:46  $
--       Date fetched Out : $Modtime:   Jun 11 2008 16:13:20  $
--       SCCS Version     : $Revision:   2.0.1.0  $
...
-- Return the SCCS id of the package
   g_body_sccsid     CONSTANT  varchar2(2000) := '$Revision:   2.0.1.0  $';
