...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/mai/admin/pck/interfaces.pkb-arc   2.20.2.0   Oct 27 2010 15:21:52   Chris.Baugh  $
--       Module Name      : $Workfile:   interfaces.pkb  $
--       Date into SCCS   : $Date:   Oct 27 2010 15:21:52  $
--       Date fetched Out : $Modtime:   Oct 27 2010 13:16:20  $
--       SCCS Version     : $Revision:   2.20.2.0  $
...
--
  ...
  g_body_sccsid  CONSTANT varchar2(2000) := '$Revision:   2.20.2.0  $';
...
BEGIN
  ...
  AND    EXISTS( SELECT 1 -- Task 0110302 - Including EXISTS to ensure rogue items not rejected due to rate mismatch
                   FROM standard_items
                  WHERE sta_item_code = icboq_sta_item_code
