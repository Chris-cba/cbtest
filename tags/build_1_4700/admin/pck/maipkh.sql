...
--   SCCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/mai/install/maipkh.sql-arc   2.13   Oct 23 2013 14:18:50   Chris.Baugh  $
--       Module Name      : $Workfile:   maipkh.sql  $
--       Date into SCCS   : $Date:   Oct 23 2013 14:18:50  $
--       Date fetched Out : $Modtime:   Oct 23 2013 14:20:58  $
...
SET define ON
SELECT '&exor_base'||'mai'||'&terminator'||'admin'||
'&terminator'||'pck'||'&terminator'||'mai_wo_api.pkh' run_file
FROM dual
/
--
START '&run_file'
...
SET define ON
SELECT '&exor_base'||'mai'||'&terminator'||'admin'||
'&terminator'||'pck'||'&terminator'||'mai_users.pkh' run_file
FROM dual
/
--
START '&run_file'
-----------------------------------------------------------------------------
-- mai_cyclic_wo package
-----------------------------------------------------------------------------
SET define ON
SELECT '&exor_base'||'mai'||'&terminator'||'admin'||
'&terminator'||'pck'||'&terminator'||'mai_cyclic_wo.pkh' run_file
FROM dual
/
--
START '&run_file'
-----------------------------------------------------------------------------
-- mai_priority package
-----------------------------------------------------------------------------
SET define ON
SELECT '&exor_base'||'mai'||'&terminator'||'admin'||
'&terminator'||'pck'||'&terminator'||'mai_priority.pkh' run_file
FROM dual
/
--
START '&run_file'
...
SET define ON
SELECT '&exor_base'||'mai'||'&terminator'||'admin'||
'&terminator'||'pck'||'&terminator'||'maiausec.pkh' run_file
FROM dual
/
--
START '&run_file'
