...
--   PVCS Identifiers :-
--
--       pvcsid           : $Header:   //vm_latest/archives/mai/admin/pck/mai_inspection_api.pkb-arc   3.25.1.0   Mar 16 2011 19:09:58   Mike.Huitson  $
--       Module Name      : $Workfile:   mai_inspection_api.pkb  $
--       Date into PVCS   : $Date:   Mar 16 2011 19:09:58  $
--       Date fetched Out : $Modtime:   Mar 16 2011 19:05:14  $
--       PVCS Version     : $Revision:   3.25.1.0  $
--
-----------------------------------------------------------------------------
--  Copyright (c) exor corporation ltd, 2007
-----------------------------------------------------------------------------
--
g_body_sccsid   CONSTANT  varchar2(2000) := '$Revision:   3.25.1.0  $';
g_package_name  CONSTANT  varchar2(30)   := 'mai_inspection_api';
--
insert_error  EXCEPTION;
/*
||Type placed in body to avoid signature change in 4300 Fix5.
*/
TYPE tre_boqs_rec
