...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/mai/install/mai4020_mai4022_upg.sql-arc   2.0   Nov 28 2007 08:56:40   jwadsworth  $
--       Module Name      : $Workfile:   mai4020_mai4022_upg.sql  $
--       Date into PVCS   : $Date:   Nov 28 2007 08:56:40  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='mai4020_mai4022_1_&log_extension'
define logfile2='mai4020_mai4022_2_&log_extension'
spool &logfile1
--get some db info
...
SELECT '&exor_base'||'mai'||'&terminator'||'install'||
        '&terminator'||'mai4020_mai4022_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'mai'||'&terminator'||'install'||
        '&terminator'||'mai4020_mai4022_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('MAI','mai4020_mai4022_upg.sql','Upgrade from 4.0.2.0 to 4.0.2.2','4.0.2.2');
END;
/
COMMIT;
SET HEADING OFF
