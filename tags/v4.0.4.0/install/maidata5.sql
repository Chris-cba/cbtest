...
--
-- Columns
-- FYR_ID                         NOT NULL VARCHAR2(5)
--   FYR_PK (Pos 1)
-- FYR_START_DATE                 NOT NULL DATE
-- FYR_END_DATE                   NOT NULL DATE
--
--
...
--
-- Columns
-- FST_RUN_DATE                   NOT NULL DATE
-- LST_RUN_DATE                   NOT NULL DATE
-- NO_OF_RUNS                     NOT NULL NUMBER(2)
-- RUN_NUM                        NOT NULL NUMBER(5)
--   HHINV_RUN_LOG_PK (Pos 1)
-- RUN_STAGE                      NOT NULL VARCHAR2(4)
-- RUN_STAT                       NOT NULL NUMBER(2)
-- ERROR_MSG                               VARCHAR2(60)
-- ITEM_CNT                                NUMBER(38)
-- ITEM_ERR_CNT                            NUMBER(38)
-- MAX_SEQ_NO                              NUMBER(8)
-- SECTION_CNT                             NUMBER(38)
-- SECTION_ERR_CNT                         NUMBER(38)
--
--
...
--
-- Columns
-- JOB_CODE                       NOT NULL VARCHAR2(1)
--   JOB_PK (Pos 1)
-- JOB_DESCR                      NOT NULL VARCHAR2(30)
-- JOB_MIN_SIZE                   NOT NULL NUMBER(12,2)
-- JOB_MAX_SIZE                   NOT NULL NUMBER(12,2)
--
--
...
--
-- Columns
-- SIS_ID                         NOT NULL VARCHAR2(3)
--   SIS_PK (Pos 1)
-- SIS_NAME                       NOT NULL VARCHAR2(60)
--   SIS_UK1 (Pos 1)
-- SIS_DESCR                               VARCHAR2(2000)
-- SIS_START_DATE                          DATE
-- SIS_END_DATE                            DATE
--
--
...
--
-- Columns
-- SISS_ID                        NOT NULL VARCHAR2(3)
--   SISS_PK (Pos 1)
-- SISS_SIS_ID                    NOT NULL VARCHAR2(3)
--   SISS_FK1 (Pos 1)
-- SISS_NAME                      NOT NULL VARCHAR2(60)
--   SISS_UK1 (Pos 1)
-- SISS_DESCR                              VARCHAR2(2000)
-- SISS_MATERIAL                           VARCHAR2(20)
-- SISS_XSP_TYPE                           VARCHAR2(1)
-- SISS_START_DATE                         DATE
-- SISS_END_DATE                           DATE
-- SISS_UNIT                               VARCHAR2(8)
--
--
...
--
-- Columns
-- VAT_ID                         NOT NULL VARCHAR2(2)
--   VAT_PK (Pos 1)
-- VAT_RATE                       NOT NULL NUMBER(4,2)
-- VAT_EFFECTIVE_DATE             NOT NULL DATE
--
--
...
--
-- Columns
-- WAC_COLUMN_NAME                NOT NULL VARCHAR2(100)
--   WAC_PK (Pos 1)
-- WAC_DISPLAY_TEXT                        VARCHAR2(255)
-- WAC_AUDITED                             VARCHAR2(1)
--
--
