...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/mai/install/mai4050_mai4052_upg.sql-arc   3.0   Feb 03 2009 15:22:18   malexander  $
--       Module Name      : $Workfile:   mai4050_mai4052_upg.sql  $
--       Date into PVCS   : $Date:   Feb 03 2009 15:22:18  $
--       Date fetched Out : $Modtime:   Feb 03 2009 15:21:40  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='mai4050_mai4052_1_&log_extension'
define logfile2='mai4050_mai4052_2_&log_extension'
spool &logfile1
--get some db info
...
begin
   hig2.pre_upgrade_check (p_product               => 'MAI'
                          ,p_new_version           => '4.0.5.2'
                          ,p_allowed_old_version_1 => '4.0.5.0'
                          );
END;
/
...
SELECT '&exor_base'||'mai'||'&terminator'||'install'||
        '&terminator'||'mai4050_mai4052_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'mai'||'&terminator'||'install'||
        '&terminator'||'mai4050_mai4052_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('MAI','mai4050_mai4052_upg.sql','Upgrade from 4.0.5.0 to 4.0.5.2','4.0.5.2');
END;
/
COMMIT;
SET HEADING OFF
