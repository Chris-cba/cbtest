...
SELECT -------------------------------------------------------------------------
       --   PVCS Identifiers :-
       --
       --       PVCS id          : $Header:   //vm_latest/archives/mai/admin/views/imf_mai_work_orders_all_attrib.vw-arc   3.0   Nov 19 2010 16:18:18   Mike.Alexander  $
       --       Module Name      : $Workfile:   imf_mai_work_orders_all_attrib.vw  $
       --       Date into PVCS   : $Date:   Nov 19 2010 16:18:18  $
