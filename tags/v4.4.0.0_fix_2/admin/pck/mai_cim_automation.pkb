...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/mai/admin/pck/mai_cim_automation.pkb-arc   3.6.1.0   Oct 13 2011 09:55:44   Chris.Baugh  $
--       Module Name      : $Workfile:   mai_cim_automation.pkb  $
--       Date into PVCS   : $Date:   Oct 13 2011 09:55:44  $
--       Date fetched Out : $Modtime:   Oct 12 2011 15:33:04  $
...
--
   ...
   --
      ...
      hig_process_api.log_it(pi_process_id   => l_process_id
                            ,pi_message      => l_msg
                            ,pi_summary_flag => 'Y' );
      -- clb 12102011 Task 0111511 nm3file.move_file(pi_file_name,'CIM_DIR',pi_file_name,'CIM_ARC',null,TRUE,l_err_no,l_error);
	  BEGIN
                         ...
                         --
                            ...
                            THEN
                                ...
                                THEN
                                    BEGIN
                                       --                                       
                                       -- clb 12102011 Task 0111511 nm3file.move_file(l_file_name,'CIM_DIR',l_file_name,'CIM_ARC',null,TRUE,l_err_no,l_error);
									   BEGIN
										  nm3file.copy_file( pi_source_dir => 'CIM_DIR' 
