...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/mai/install/maidata3.sql-arc   2.19   Oct 03 2019 09:00:32   Chris.Baugh  $
--       Module Name      : $Workfile:   maidata3.sql  $
--       Date into PVCS   : $Date:   Oct 03 2019 09:00:32  $
--       Date fetched Out : $Modtime:   Oct 02 2019 10:51:28  $
...
SELECT 'MAI_ADMIN'
      ,'MAI'
      ,'Maintenance Manager Administration'
  FROM DUAL
...
SELECT 'MAI_READONLY'
      ,'MAI'
      ,'Maintenance Manager Readonly Access'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_ROLES
