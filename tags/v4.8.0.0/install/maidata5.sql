...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/mai/install/maidata5.sql-arc   2.14   Oct 03 2019 09:00:32   Chris.Baugh  $
--       Module Name      : $Workfile:   maidata5.sql  $
--       Date into PVCS   : $Date:   Oct 03 2019 09:00:32  $
--       Date fetched Out : $Modtime:   Oct 02 2019 10:51:34  $
...
SELECT '2008'
      ...
      ,to_date('20090331000000','YYYYMMDDHH24MISS')
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM FINANCIAL_YEARS
                   WHERE FYR_ID = '2008');
...
SELECT '2009'
      ...
      ,to_date('20100331000000','YYYYMMDDHH24MISS')
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM FINANCIAL_YEARS
                   WHERE FYR_ID = '2009');
...
SELECT '2010'
      ...
      ,to_date('20110331000000','YYYYMMDDHH24MISS')
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM FINANCIAL_YEARS
                   WHERE FYR_ID = '2010');
...
SELECT '2011'
      ...
      ,to_date('20120331000000','YYYYMMDDHH24MISS')
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM FINANCIAL_YEARS
                   WHERE FYR_ID = '2011');
...
SELECT '2012'
      ...
      ,to_date('20130331000000','YYYYMMDDHH24MISS')
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM FINANCIAL_YEARS
                   WHERE FYR_ID = '2012');
...
SELECT '2013'
      ...
      ,to_date('20140331000000','YYYYMMDDHH24MISS')
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM FINANCIAL_YEARS
                   WHERE FYR_ID = '2013');
...
SELECT '2014'
      ...
      ,to_date('20150331000000','YYYYMMDDHH24MISS')
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM FINANCIAL_YEARS
                   WHERE FYR_ID = '2014');
...
SELECT '2015'
      ...
      ,to_date('20160331000000','YYYYMMDDHH24MISS')
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM FINANCIAL_YEARS
                   WHERE FYR_ID = '2015');
...
INSERT
  INTO HHINV_RUN_LOG
      ...
      ,SECTION_CNT
      ,SECTION_ERR_CNT)
SELECT to_date('19010101000000','YYYYMMDDHH24MISS')
...
--
INSERT
  INTO STANDARD_ITEM_SUB_SECTIONS
      (SISS_ID
      ,SISS_SIS_ID
      ,SISS_NAME
      ,SISS_DESCR
...
SELECT '1'
      ,17.5
      ,to_date('19950101000000','YYYYMMDDHH24MISS')
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM VAT_RATES
                   WHERE VAT_ID = '1');
...
SELECT 'MAI2510'
      ...
      ,'hgc'
      ,'N'
      ,'hgc.hco_domain = ''INITIATION_TYPE'''
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
...
SELECT 'MAI2510'
      ...
      ,'hc2'
      ,'N'
      ,'hc2.hco_domain = ''DEFECT_PRIORITIES'''
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_HD_LOOKUP_JOIN_DEFS
                   WHERE HHL_HHU_HHM_MODULE = 'MAI2510'
...
SELECT 'MAI2530_A'
      ...
      ,'dty'
      ,'N'
      ,'dty_hh_attribute_1 IS NOT NULL'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_HD_LOOKUP_JOIN_DEFS
                   WHERE HHL_HHU_HHM_MODULE = 'MAI2530_A'
...
SELECT 'MAI2530_A'
      ...
      ,'dty'
      ,'N'
      ,'dty_hh_attribute_2 IS NOT NULL'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_HD_LOOKUP_JOIN_DEFS
                   WHERE HHL_HHU_HHM_MODULE = 'MAI2530_A'
...
SELECT 'MAI2530_A'
      ...
      ,'dty'
      ,'N'
      ,'dty_hh_attribute_3 IS NOT NULL'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_HD_LOOKUP_JOIN_DEFS
                   WHERE HHL_HHU_HHM_MODULE = 'MAI2530_A'
...
SELECT 'MAI2530_A'
      ...
      ,'dty'
      ,'N'
      ,'dty_hh_attribute_4 IS NOT NULL'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_HD_LOOKUP_JOIN_DEFS
                   WHERE HHL_HHU_HHM_MODULE = 'MAI2530_A'
