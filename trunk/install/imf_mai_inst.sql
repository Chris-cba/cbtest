...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/mai/install/imf_mai_inst.sql-arc   3.3   Sep 27 2019 15:56:16   Chris.Baugh  $
--       Module Name      : $Workfile:   imf_mai_inst.sql  $
--       Date into PVCS   : $Date:   Sep 27 2019 15:56:16  $
--       Date fetched Out : $Modtime:   Sep 27 2019 15:39:52  $
...
select decode(upper('&ok_res'),'Y','&exor_base'||'mai'||'&terminator'||'install'||'&terminator'||'imf_mai_install.sql','exit') run_file
from dual
/
