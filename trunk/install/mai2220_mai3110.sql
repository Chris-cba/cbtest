...
REM @(#)$Header:   //vm_latest/archives/mai/install/mai2220_mai3110.sql-arc   2.1   Jul 01 2013 16:02:12   James.Wadsworth  $
...
select decode(upper('&ok_res'),'Y','&exor_base'||'mai'||'&terminator'||
        'install'||'&terminator'||'mai2220_mai3110_upg','exit') run_file
from dual
/
