...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/mai/install/mai3110_mai3200.sql-arc   2.1   Jul 01 2013 16:02:16   James.Wadsworth  $
--       Module Name      : $Workfile:   mai3110_mai3200.sql  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'mai'||'&terminator'||
        'install'||'&terminator'||'mai3110_mai3200_upg','exit') run_file
FROM dual
/
START '&run_file'
--
