...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/mai/install/mai3110_mai3200_upg.sql-arc   2.1   Jul 01 2013 16:02:16   James.Wadsworth  $
--       Module Name      : $Workfile:   mai3110_mai3200_upg.sql  $
...
define logfile1='mai3110_mai3200_1_&log_extension'
define logfile2='mai3110_mai3200_2_&log_extension'
spool &logfile1
...
---------------------------------------------------------------------------------------------------
--                        ****************   META-DATA   *******************
-- no metadata from 3110 to 3120
-- no metadata from 3120 to 3130
SET TERM ON
PROMPT Metadata...
SET TERM OFF
SET DEFINE ON
...
BEGIN
      hig2.upgrade('MAI','mai3110_mai3200_upg.sql','Upgrade from 3.1.1.0 to 3.2.0.0','3.2.0.0');
      hig2.upgrade('PMS','mai3110_mai3200_upg.sql','Upgrade from 3.1.1.0 to 3.2.0.0','3.2.0.0');      
END;
/
COMMIT;
