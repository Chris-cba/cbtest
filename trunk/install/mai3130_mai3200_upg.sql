...
--   SCCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/mai/install/mai3130_mai3200_upg.sql-arc   2.1   Jul 01 2013 16:02:16   James.Wadsworth  $
--       Module Name      : $Workfile:   mai3130_mai3200_upg.sql  $
...
define logfile1='mai3130_mai3200_1_&log_extension'
define logfile2='mai3130_mai3200_2_&log_extension'
spool &logfile1
...
BEGIN
      hig2.upgrade('MAI','mai3130_mai3200_upg.sql','Upgrade from 3.1.3.0 to 3.2.0.0','3.2.0.0');
      hig2.upgrade('PMS','mai3130_mai3200_upg.sql','Upgrade from 3.1.3.0 to 3.2.0.0','3.2.0.0');      
END;
/
COMMIT;
