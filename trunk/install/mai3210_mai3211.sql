...
--   SCCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/mai/install/mai3210_mai3211.sql-arc   2.1   Jul 01 2013 16:02:18   James.Wadsworth  $
--       Module Name      : $Workfile:   mai3210_mai3211.sql  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'mai'||'&terminator'||
        'install'||'&terminator'||'mai3210_mai3211_upg','exit') run_file
FROM dual
/
