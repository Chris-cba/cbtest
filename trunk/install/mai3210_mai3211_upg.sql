...
--   SCCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/mai/install/mai3210_mai3211_upg.sql-arc   2.1   Jul 01 2013 16:02:18   James.Wadsworth  $
--       Module Name      : $Workfile:   mai3210_mai3211_upg.sql  $
...
define logfile1='mai3210_mai3211_1_&log_extension'
define logfile2='mai3210_mai3211_2_&log_extension'
spool &logfile1
...
SELECT '&exor_base'||'mai'||'&terminator'||'install'||
        '&terminator'||'mai3210_mai3211_ddl_upg' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'mai'||'&terminator'||'install'||
        '&terminator'||'mai3210_mai3211_metadata_upg' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
BEGIN
      hig2.upgrade('MAI','mai3210_mai3211_upg.sql','Upgrade from 3.2.1.0 to 3.2.1.1','3.2.1.1');
END;
/
COMMIT;
