...
--   SCCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/mai/install/mai3210_mai3220.sql-arc   2.1   Jul 01 2013 16:02:20   James.Wadsworth  $
--       Module Name      : $Workfile:   mai3210_mai3220.sql  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&terminator'||'mai'||'&terminator'||
        'install'||'&terminator'||'mai3210_mai3220_upg','exit') run_file
FROM dual
/
