...
--   SCCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/mai/install/mai3210_mai3220_upg.sql-arc   2.1   Jul 01 2013 16:02:20   James.Wadsworth  $
--       Module Name      : $Workfile:   mai3210_mai3220_upg.sql  $
...
define logfile1='mai3210_mai3220_1_&log_extension'
define logfile2='mai3210_mai3220_2_&log_extension'
spool
...
SET DEFINE ON
SELECT '&exor_base'||'mai'||'&terminator'||'install'||
        '&terminator'||'mai3210_mai3220_ddl_upg' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET define ON
SELECT '&exor_base'||'nm3'||''||'admin'||
''||'utl'||''||'compile_schema.sql' run_file
FROM dual
/
start &&run_file''
...
SET DEFINE ON
SELECT '&exor_base'||'mai'||'&terminator'||'install'||
        '&terminator'||'mai3210_mai3220_metadata_upg' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
BEGIN
      hig2.upgrade('MAI','mai3210_mai3220_upg.sql','Upgrade from 3.2.1.0 to 3.2.2.0','3.2.2.0');
END;
/
COMMIT;
