...
--   SCCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/mai/install/mai4010_mai4020.sql-arc   2.1   Jul 01 2013 16:02:44   James.Wadsworth  $
--       Module Name      : $Workfile:   mai4010_mai4020.sql  $
--       Date into SCCS   : $Date:   Jul 01 2013 16:02:44  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'mai'||'&terminator'||
        'install'||'&terminator'||'mai4010_mai4020_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
