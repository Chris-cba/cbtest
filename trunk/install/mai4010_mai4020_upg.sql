...
--   PVCS Identifiers :-
--
--       pvcsid                 : $Header:   //vm_latest/archives/mai/install/mai4010_mai4020_upg.sql-arc   2.3   Jul 01 2013 16:02:44   James.Wadsworth  $
--       Module Name      : $Workfile:   mai4010_mai4020_upg.sql  $
--       Date into PVCS   : $Date:   Jul 01 2013 16:02:44  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='mai4010_mai4020_1_&log_extension'
define logfile2='mai4010_mai4020_2_&log_extension'
spool &logfile1
--get some db info
...
SET DEFINE ON
SELECT '&exor_base'||'mai'||'&terminator'||'install'||
        '&terminator'||'mai4010_mai4020_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('MAI','mai4010_mai4020_upg.sql','Upgrade from 4.0.1.0 to 4.0.2.0','4.0.2.0');
END;
/
COMMIT;
SET HEADING OFF
