...
-- PVCS Identifiers :-
--
-- pvcsid : $Header:   //vm_latest/archives/mai/install/mai4010_mai4022.sql-arc   2.1   Jul 01 2013 16:03:02   James.Wadsworth  $
-- Module Name : $Workfile:   mai4010_mai4022.sql  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'mai'||'&terminator'||
        'install'||'&terminator'||'mai4010_mai4022_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
