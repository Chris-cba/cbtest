...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/mai/install/mai4020_mai4040.sql-arc   3.0   Jan 11 2008 11:36:18   jwadsworth  $
--       Module Name      : $Workfile:   mai4020_mai4040.sql  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'mai'||'&terminator'||
        'install'||'&terminator'||'mai4020_mai4040_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
