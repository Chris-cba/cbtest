...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/mai/install/mai4040_mai4041_upg.sql-arc   2.1   Feb 18 2008 14:13:10   jwadsworth  $
--       Module Name      : $Workfile:   mai4040_mai4041_upg.sql  $
--       Date into PVCS   : $Date:   Feb 18 2008 14:13:10  $
--       Date fetched Out : $Modtime:   Feb 14 2008 11:07:22  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='mai4040_mai4041_1_&log_extension'
define logfile2='mai4040_mai4041_2_&log_extension'
spool &logfile1
--get some db info
...
SELECT '&exor_base'||'mai'||'&terminator'||'install'||
        '&terminator'||'mai4040_mai4041_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'mai'||'&terminator'||'install'||
        '&terminator'||'mai4040_mai4041_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('MAI','mai4040_mai4041_upg.sql','Upgrade from 4.0.4.0 to 4.0.4.1','4.0.4.1');
END;
/
COMMIT;
SET HEADING OFF
