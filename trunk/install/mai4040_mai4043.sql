...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/mai/install/mai4040_mai4043.sql-arc   3.1   Jul 01 2013 16:03:06   James.Wadsworth  $
--       Module Name      : $Workfile:   mai4040_mai4043.sql  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'mai'||'&terminator'||
        'install'||'&terminator'||'mai4040_mai4043_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
