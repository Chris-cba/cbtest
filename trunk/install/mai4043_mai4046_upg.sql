...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/mai/install/mai4043_mai4046_upg.sql-arc   3.1   Jul 01 2013 16:03:06   James.Wadsworth  $
--       Module Name      : $Workfile:   mai4043_mai4046_upg.sql  $
--       Date into PVCS   : $Date:   Jul 01 2013 16:03:06  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='mai4043_mai4046_1_&log_extension'
define logfile2='mai4043_mai4046_2_&log_extension'
spool &logfile1
--get some db info
...
SELECT '&exor_base'||'mai'||'&terminator'||'install'||
        '&terminator'||'mai4043_mai4046_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'mai'||'&terminator'||'install'||
        '&terminator'||'mai4043_mai4046_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('MAI','mai4043_mai4046_upg.sql','Upgrade from 4.0.4.3 to 4.0.4.6','4.0.4.6');
END;
/
COMMIT;
SET HEADING OFF
