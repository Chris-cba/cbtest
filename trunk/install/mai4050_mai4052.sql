...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/mai/install/mai4050_mai4052.sql-arc   3.0   Feb 03 2009 15:22:18   malexander  $
--       Module Name      : $Workfile:   mai4050_mai4052.sql  $
--       Date into PVCS   : $Date:   Feb 03 2009 15:22:18  $
--       Date fetched Out : $Modtime:   Feb 03 2009 15:18:18  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'mai'||'&terminator'||
        'install'||'&terminator'||'mai4050_mai4052_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
