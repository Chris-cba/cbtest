...
--   SCCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/mai/install/mai40_mai4010.sql-arc   2.1   Jul 01 2013 16:02:22   James.Wadsworth  $
--       Module Name      : $Workfile:   mai40_mai4010.sql  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'mai'||'&terminator'||
        'install'||'&terminator'||'mai40_mai4010_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
