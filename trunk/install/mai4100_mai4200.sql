...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/mai/install/mai4100_mai4200.sql-arc   3.0   Dec 15 2009 23:02:26   mhuitson  $
--       Module Name      : $Workfile:   mai4100_mai4200.sql  $
--       Date into PVCS   : $Date:   Dec 15 2009 23:02:26  $
--       Date fetched Out : $Modtime:   Dec 09 2009 18:20:04  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'mai'||'&terminator'||
        'install'||'&terminator'||'mai4100_mai4200_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
