...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/mai/install/mai4200_mai4210.sql-arc   3.0   Apr 13 2010 09:44:42   malexander  $
--       Module Name      : $Workfile:   mai4200_mai4210.sql  $
--       Date into PVCS   : $Date:   Apr 13 2010 09:44:42  $
--       Date fetched Out : $Modtime:   Apr 13 2010 09:43:40  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'mai'||'&terminator'||
        'install'||'&terminator'||'mai4200_mai4210_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
