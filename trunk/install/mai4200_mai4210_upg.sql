...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/mai/install/mai4200_mai4210_upg.sql-arc   3.0   Apr 12 2010 14:20:20   malexander  $
--       Module Name      : $Workfile:   mai4200_mai4210_upg.sql  $
--       Date into PVCS   : $Date:   Apr 12 2010 14:20:20  $
--       Date fetched Out : $Modtime:   Apr 12 2010 14:18:36  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='mai4200_mai4210_1_&log_extension'
define logfile2='mai4200_mai4210_2_&log_extension'
spool &logfile1
--get some db info
...
SET TERM OFF
BEGIN
      hig2.upgrade('MAI','mai4200_mai4210_upg.sql','Upgrade from 4.2.0.0 to 4.2.1.0','4.2.1.0');
END;
/
COMMIT;
SET HEADING OFF
