...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/mai/install/mai4200_mai4300.sql-arc   3.0   Sep 27 2010 10:54:16   mike.alexander  $
--       Module Name      : $Workfile:   mai4200_mai4300.sql  $
--       Date into PVCS   : $Date:   Sep 27 2010 10:54:16  $
--       Date fetched Out : $Modtime:   Sep 27 2010 10:28:04  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'mai'||'&terminator'||
        'install'||'&terminator'||'mai42x0_mai4300_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
