...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/mai/install/mai4520_mai4700.sql-arc   1.0   Dec 16 2013 08:46:18   Chris.Baugh  $
--       Module Name      : $Workfile:   mai4520_mai4700.sql  $
--       Date into PVCS   : $Date:   Dec 16 2013 08:46:18  $
--       Date fetched Out : $Modtime:   Sep 24 2013 10:26:36  $
...
SELECT DECODE(UPPER('&ok_res'),'Y','&exor_base'||'mai'||'&terminator'||
        'install'||'&terminator'||'mai4520_mai4700_upg.sql','exit') run_file
FROM dual
/
start '&run_file'
prompt
