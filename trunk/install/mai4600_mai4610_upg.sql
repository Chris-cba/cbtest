...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/mai/install/mai4600_mai4610_upg.sql-arc   1.2   Jul 01 2013 16:03:32   James.Wadsworth  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='mai4600_mai4610_1_&log_extension'
define logfile2='mai4600_mai4610_2_&log_extension'
spool &logfile1
--get some db info
...
SELECT '&exor_base'||'mai'||'&terminator'||'install'||
        '&terminator'||'mai4600_mai4610_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'mai'||'&terminator'||'install'||
        '&terminator'||'mai4600_mai4610_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('MAI','mai4600_mai4610_upg.sql','Upgrade from 4.6.0.0 to 4.6.1.0','4.6.1.0');
END;
/
COMMIT;
SET HEADING OFF
