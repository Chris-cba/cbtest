...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/mai/install/mai4610_mai4700_upg.sql-arc   1.0   Dec 16 2013 08:46:20   Chris.Baugh  $
--       Module Name      : $Workfile:   mai4610_mai4700_upg.sql  $
--       Date into PVCS   : $Date:   Dec 16 2013 08:46:20  $
--       Date fetched Out : $Modtime:   Nov 08 2013 13:54:46  $
...
---------------------------------------------------------------------------------------------------
-- Spool to Logfile
define logfile1='mai4610_mai4700_1_&log_extension'
define logfile2='mai4610_mai4700_2_&log_extension'
spool &logfile1
--get some db info
...
begin
   hig2.pre_upgrade_check (p_product               => 'MAI'
                          ,p_new_version           => '4.7.0.0'
                          ,p_allowed_old_version_1 => '4.6.1.0'
                          );
END;
/
...
SELECT '&exor_base'||'mai'||'&terminator'||'install'||
        '&terminator'||'mai4610_mai4700_ddl_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET DEFINE ON
SELECT '&exor_base'||'mai'||'&terminator'||'install'||
        '&terminator'||'mai4610_mai4700_metadata_upg.sql' run_file
FROM dual
/
SET FEEDBACK ON
start &&run_file
...
SET TERM OFF
BEGIN
      hig2.upgrade('MAI','mai4610_mai4700_upg.sql','Upgrade from 4.6.1.0 to 4.7.0.0','4.7.0.2');
END;
/
COMMIT;
SET HEADING OFF
