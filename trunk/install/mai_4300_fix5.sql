...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/mai/install/mai_4300_fix5.sql-arc   3.2   Jul 01 2013 16:01:50   James.Wadsworth  $
...
-- Spool to Logfile
--
define logfile1='mai_4300_fix5_1_&log_extension'
spool &logfile1
--
--------------------------------------------------------------------------------
--
...
BEGIN
 ...
 IF l_dummy IS NULL THEN
   RAISE_APPLICATION_ERROR(-20001,'"Maintenance Manager 4300 Fixes 1, 2, 3 and 4" must be applied before proceeding - contact exor support for further information');
 END IF;
...
--
SET TERM ON 
PROMPT mai_4300_fix5_metadata_upg.sql
SET TERM OFF
--
SET FEEDBACK ON
start mai_4300_fix5_metadata_upg.sql
SET FEEDBACK OFF
--
--------------------------------------------------------------------------------
...
--
SET TERM ON 
PROMPT log_mai_4300_fix5.sql 
--
SET FEEDBACK ON
start log_mai_4300_fix5.sql
SET FEEDBACK OFF
SPOOL OFF
EXIT
--
