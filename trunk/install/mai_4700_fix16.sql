...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/mai/install/mai_4700_fix16.sql-arc   1.0   Mar 16 2017 15:00:24   Chris.Baugh  $
--       Module Name      : $Workfile:   mai_4700_fix16.sql  $
--       Date into PVCS   : $Date:   Mar 16 2017 15:00:24  $
--       Date fetched Out : $Modtime:   Jan 29 2016 09:50:24  $
...
-- Spool to Logfile
--
define logfile1='mai_4700_fix16_1_&log_extension'
spool &logfile1
--
--------------------------------------------------------------------------------
--
...
--
SET TERM ON 
PROMPT log_mai_4700_fix16.sql 
--
SET FEEDBACK ON
start log_mai_4700_fix16.sql
SET FEEDBACK OFF
SPOOL OFF
EXIT
--