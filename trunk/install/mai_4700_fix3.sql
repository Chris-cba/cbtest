...
-- Spool to Logfile
--
define logfile1='mai_4700_fix3_1_&log_extension'
spool &logfile1
--
--------------------------------------------------------------------------------
--
...
--------------------------------------------------------------------------------
SET TERM ON 
PROMPT Adding new product option DEFDOCCAT into HIG_OPTION_LIST
SET TERM OFF
--
...
--
SET TERM ON 
PROMPT Adding DEFDOCTYPE,DEFDOCLOCN as User Options
SET TERM OFF
--
...
--
SET TERM ON 
PROMPT log_mai_4700_fix3.sql 
--
SET FEEDBACK ON
start log_mai_4700_fix3.sql
SET FEEDBACK OFF
SPOOL OFF
EXIT
--
