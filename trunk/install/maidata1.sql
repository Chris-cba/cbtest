...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/mai/install/maidata1.sql-arc   2.34   Oct 09 2019 16:18:36   Chris.Baugh  $
--       Module Name      : $Workfile:   maidata1.sql  $
--       Date into PVCS   : $Date:   Oct 09 2019 16:18:36  $
--       Date fetched Out : $Modtime:   Oct 09 2019 13:43:50  $
--       Version          : $Revision:   2.34  $
--       Table Owner      : MAI_METADATA
--       Generation Date  : 09-OCT-2019 13:43
--
...
SELECT 'MAI'
      ...
      ,'Trying to load an invoice which is not the latest'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM NM_ERRORS
                   WHERE NER_APPL = 'MAI'
...
INSERT
  INTO HIG_OPTION_VALUES
      ...
      ,HOV_VALUE)
SELECT 'WORSTDTXT'
      ,'IN ACCORDANCE WITH TERM MAINTENANCE CONTRACT'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_OPTION_VALUES
...
SELECT 'DEFECTS'
      ...
      ,'At least one repair on the defect has been assigned to a work order that has not yet been instructed.'||CHR(10)||'This status will be set in MAI3800 or MAI3801.'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_STATUS_DOMAINS
...
SELECT 'WORK_ORDER_LINES'
      ...
      ,'Initial Work Order Line Status'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM HIG_STATUS_DOMAINS
...
--
INSERT
  INTO HIG_CHECK_CONSTRAINT_ASSOCS
...
INSERT
  INTO HIG_STANDARD_FAVOURITES
      ...
      ,HSTF_TYPE
      ,HSTF_ORDER)
SELECT 'MAI_REF_FINANCIAL_REPORTS'
      ,'MAI2780'
      ,'Print Item Code Breakdowns'
      ,'M'
      ,2
...
INSERT
  INTO HIG_STANDARD_FAVOURITES
      ...
      ,HSTF_TYPE
      ,HSTF_ORDER)
SELECT 'MAI_REF_INSPECTIONS_REPORTS'
      ,'MAI1808'
      ,'List of Organisations'
      ,'M'
      ,1
...
INSERT
  INTO HIG_STANDARD_FAVOURITES
      ...
      ,HSTF_TYPE
      ,HSTF_ORDER)
SELECT 'MAI_REF_INVENTORY_REPORTS'
      ,'MAI5050'
      ,'Print List of Inventory Item Types, Attributes and Values'
      ,'M'
      ,1
...
INSERT
  INTO HIG_STANDARD_FAVOURITES
      ...
      ,HSTF_TYPE
      ,HSTF_ORDER)
SELECT 'MAI_REF_MAINTENANCE_REPORTS'
      ,'MAI5024'
      ,'Print Local Frequencies and Intervals'
      ,'M'
      ,2
