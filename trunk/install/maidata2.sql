...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //new_vm_latest/archives/mai/install/maidata2.sql-arc   2.19   Oct 03 2019 09:00:32   Chris.Baugh  $
--       Module Name      : $Workfile:   maidata2.sql  $
--       Date into PVCS   : $Date:   Oct 03 2019 09:00:32  $
--       Date fetched Out : $Modtime:   Oct 02 2019 10:51:26  $
--       Version          : $Revision:   2.19  $
--       Table Owner      : MAI_METADATA
--       Generation Date  : 02-OCT-2019 10:51
--
...
SELECT 'R_OR_C_OR_A'
      ,'R'
      ,'Raised (Uncompleted) Works Orders'
  FROM DUAL
 WHERE NOT EXISTS(SELECT 1
                    FROM GRI_PARAM_LOOKUP
                   WHERE GPL_PARAM = 'R_OR_C_OR_A'
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid defect attribute combination.'
      ,9025
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Activity (H) Record expected but not found.'
      ,9104
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid Comment Type.'
      ,9105
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : G record expected but not found.'
      ,9200
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Number of attributes in G record type is less than 7'
      ,9201
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Initiation nmeonic is not recognised.'
      ,9202
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid initiation inspection date.'
      ,9203
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid initiation inspection time.'
      ,9204
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid survey type indicator.'
      ,9205
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid survey direction indicator.'
      ,9206
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid Linkcode / Section identifier.'
      ,9207
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : The Primary inspector cannot be located.'
      ,9208
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : The Secondary inspector cannot be located.'
      ,9209
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Defect sequence value DEF_DEFECT_ID missing from CODE_CONTROLS'
      ,9210
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid Road Surface condition code.'
      ,9211
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid Weather condition code.'
      ,9212
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Unable to obtain interval code.'
      ,9213
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Unable to locate specified section.'
      ,9214
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Unable to obtain document sequence number.'
      ,9215
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Unable to obtain inspectors Admin unit.'
      ,9216
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Unable to insert into the DOCS table.'
      ,9217
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Unable to insert into the DOC_ASSOCS table.'
      ,9218
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Unable to obtain the status for a new defect.'
      ,9219
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : H record expected but not found.'
      ,9220
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid activity area code on H type record for this section.'
      ,9221
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : P record expected but not found.'
      ,9240
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Chainage on I record exceeds required chainage for section.'
      ,9260
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid defect Location time.'
      ,9261
      ,'Correct the defect location time hhmm'
      ,''
      ,''
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid chainage indicator.'
      ,9262
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid sub-section item code.'
      ,9263
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid notifiable organisation code.'
      ,9264
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid rechargeable organisation code.'
      ,9265
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid Cross Sectional Position (XSP)'
      ,9266
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid activity nmeonic/defect code combination.'
      ,9300
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid inspection time.'
      ,9301
      ,'Correct the inspection time in the G record.'
      ,''
      ,''
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid Inspection date.'
      ,9302
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid Survey type.'
      ,9303
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid defect priority code.'
      ,9304
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid Defect/Priority combination.'
      ,9305
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid reverse survey direction indicator.'
      ,9309
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid Treatment Code.'
      ,9400
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Start chainage exceeds end chainage.'
      ,9401
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Incorrect start chainage value ( chainage is null )'
      ,9402
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Inspection Date less than previously loaded inspection.  '
      ,9500
      ,'Correct the inspection date.'
      ,''
      ,''
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid Defect Location (I) Record Type.'
      ,9501
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid Defect (J) record Type.'
      ,9502
      ,'Correct the Defect Location Record Type indicator.'
      ,''
      ,''
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Action record (K/L/M/N) expected but not found.'
      ,9503
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Section chainage record (P) expected but not found.'
      ,9504
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Repair record expected but not found.'
      ,9505
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Repair target date cannot be obtained from defect priorities.'
      ,9506
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Unable to obtain system option WEEKEND.'
      ,9507
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Unable to obtain the current day from DUAL.'
      ,9508
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Unable to locate defect priority interval record.'
      ,9509
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid action completion date.'
      ,9510
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid action completion time.'
      ,9511
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Job item location error.'
      ,9512
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Q type record expected but not found.'
      ,9513
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : R type record expected but not found.'
      ,9514
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : S type record expected but not found.'
      ,9515
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Unable to locate INTERVAL record.'
      ,9516
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : An immediate (COMPLETED) repair may NOT have BOQ items.'
      ,9517
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Recalibration for section inspection not started at chainage 0 '
      ,9600
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Recalibration for section execeeds 50% of section length .'
      ,9601
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Error cannot find P record to carry out recalibration.'
      ,9602
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Defect XSP required but not supplied.'
      ,9603
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : No Default Treatment for this Defect / Activity area.'
      ,9604
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Defect chainage value required but not supplied.'
      ,9605
      ,'Correct the defect location record.'
      ,''
      ,''
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid complaint record date.'
      ,9701
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid complaint record time.'
      ,9702
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Error : Invalid complaint source code.'
      ,9703
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Invalid Combination of Complaint Category / Complaint Type'
      ,9704
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Invalid defect Response Category. Use the DOMAINS form.'
      ,9705
...
INSERT
  INTO LOAD_ERRORS
      ...
      ,LER_ACTION_3
      ,LER_ACTION_4)
SELECT 'Could not derive Default Complaint Status'
      ,9706
