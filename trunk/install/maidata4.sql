...
--   PVCS Identifiers :-
--
--       PVCS id          : $Header:   //vm_latest/archives/mai/install/maidata4.sql-arc   2.13   Oct 04 2010 10:09:16   mike.alexander  $
--       Module Name      : $Workfile:   maidata4.sql  $
--       Date into PVCS   : $Date:   Oct 04 2010 10:09:16  $
--       Date fetched Out : $Modtime:   Oct 04 2010 10:06:44  $
...
SELECT 
       ...
       ,'N'
       ,to_date('20101004095103','YYYYMMDDHH24MISS')
       ,to_date('20101004100417','YYYYMMDDHH24MISS')
       ,'MAI_METADATA'
       ,'MAI_METADATA'
...
SELECT 
       ...
       ,'N'
       ,'N'
       ,to_date('20101004095121','YYYYMMDDHH24MISS')
       ,to_date('20101004095121','YYYYMMDDHH24MISS')
       ,'MAI_METADATA'
       ,'MAI_METADATA'
...
SELECT 
       ...
       ,'N'
       ,'N'
       ,to_date('20101004095122','YYYYMMDDHH24MISS')
       ,to_date('20101004095122','YYYYMMDDHH24MISS')
       ,'MAI_METADATA'
       ,'MAI_METADATA'
       ,''
