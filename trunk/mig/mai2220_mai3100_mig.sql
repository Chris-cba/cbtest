...
--   PVCS Identifiers :-
--
--       sccsid           : $Header:   //vm_latest/archives/mai/mig/mai2220_mai3100_mig.sql-arc   2.1   Jul 01 2013 16:00:08   James.Wadsworth  $
--       Module Name      : $Workfile:   mai2220_mai3100_mig.sql  $
...
add nit_inv_type varchar2(4);

update inv_item_types 
set nit_inv_type = ity_sys_flag||'_'||ity_inv_code;

alter table inv_item_types
modify nit_inv_type not null;

rename inv_item_types to inv_type_translations;
...
---------------------------------------------------------------------------------------------------
Prompt
Prompt RE-CREATING MAI SEQS
Prompt =====================
select '&exor_base'||'mai'||'&terminator'||'install'||
        '&terminator'||'mai2220_create_sequences.sql' run_file
from dual
/
...
--
set term on
Prompt Creating NM3 synonyms for MAI
set define on
set feedback off
select '&exor_base'||'mai'||'&terminator'||'install'||
...
set term on
Prompt Creating MAI Translation Views
set term off
set define on
set feedback off
...
-------------------------------------------
Prompt
Prompt Removing Redundant Modules/Module Role Data
Prompt ===========================================
